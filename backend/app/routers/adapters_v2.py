"""
Enhanced adapter router with timeline/version history support.
"""
...
from ..models.adapter import Adapter, AdapterVersion
...
@router.post("", response_model=AdapterRead)
async def create_adapter(
    ...
    adapter = Adapter(
        ...
        base_model=adapter_in.base_model,
