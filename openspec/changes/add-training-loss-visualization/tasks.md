...
- [x] **1.1 Create metric parsing utilities**
...
- [x] **1.2 Integrate metric parsing into log capture**
...
- [x] **1.3 Add metrics API endpoint**
...
- [x] **1.4 Test backend metrics end-to-end**
...
- [x] **2.1 Create base TrainingMetricsChart component**
...
- [x] **2.3 Implement data fetching with polling**
...
- [x] **2.4 Style and polish chart component**
...
- [x] **3.1 Integrate chart into Runs tab**
...
- [x] **3.2 Add metric type selector**
...
- [x] **4.1 Support multiple runs in chart component**
...
- [x] **4.2 Integrate into comparison view**
