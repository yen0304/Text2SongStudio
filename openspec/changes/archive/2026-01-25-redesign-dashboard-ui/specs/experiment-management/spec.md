...
## Purpose
Manage training experiments and runs for systematic model improvement. Supports tracking multiple training attempts, comparing results, and organizing the model development lifecycle.
